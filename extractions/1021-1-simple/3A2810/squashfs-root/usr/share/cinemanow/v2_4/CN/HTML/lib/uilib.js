...
}return this;},removeListener:function(m,l){if(this.removeEventListener){this.removeEventListener(m,l,false);}else{try{this.detachEvent("on"+m,l);}catch(e){}}return this;
