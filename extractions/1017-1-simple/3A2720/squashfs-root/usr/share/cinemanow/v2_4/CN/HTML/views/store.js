                        ...
                        if(result) {
                            ...
                            application.testConnection(function(cb) {
                                ...
                                if(cb.result) {
                                    ...
                                    BrowseView.showPlayer(payload.args[0].titleID, payload.args[0].streamID, payload.args[0].url, payload.args[0].startTimeSeconds, payload.args[0].isHd, payload.args[0].passID);
                                } else {
                                    application.events.publish("error", {
